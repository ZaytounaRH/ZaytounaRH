...
public class Employe extends User
{
    ...
    public Employee(String numTel, int joursOuvrables, String nom, String prenom, String address, String email, String gender, java.sql.Date dateDeNaissance, String userType, String password, int idEmployee) {
        super(numTel, joursOuvrables, nom, prenom, address, email, gender, dateDeNaissance, userType, password);
        this.idEmployee = idEmployee;
    }

    public Employee(int id, String numTel, int joursOuvrables, String nom, String prenom, String address, String email, String gender, java.sql.Date dateDeNaissance, String userType, String password, int idEmployee) {
