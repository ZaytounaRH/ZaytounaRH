...
public class GestionEntretien {
    ...
    public void updateEntretien() {
        if (isInputValid()) {
            ...
            // Convertir le String en StatutEntretien
            String statutEntretienString = statutEntretienComboBox.getValue();
            Entretien.StatutEntretien statutEntretien = Entretien.StatutEntretien.valueOf(statutEntretienString); // Convertir en Enum
            entretien.setStatut(statutEntretien);
    ...
    private void clearFields() {
        ...
        heureEntretienSpinner.getValueFactory().setValue(0); // Remise à zéro de l'heure
