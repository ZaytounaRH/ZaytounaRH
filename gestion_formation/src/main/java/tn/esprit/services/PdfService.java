...
public class PdfService {
    ...
    public File genererCertificatPdf(Certification certif, Date dateObtention) {
        // Chemin de sauvegarde du PDF
        String outputPath = "certification_" + certif.getTitreCertif() + ".pdf";
        File pdfFile = new File(outputPath);  // Crée un objet File pour le fichier de sortie
        ...
        return pdfFile;  // Retourner le fichier PDF généré
    }
